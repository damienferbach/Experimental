...
srun --ntasks=4 --cpus-per-task=$SLURM_CPUS_PER_GPU \
     ...
     bash -c '
        ...
        python nanogpt_log_losses_dana.py --train_steps=100000 --batch_size=32 --val_batch_size=32 --seq_len=1024 --dana_g2=0.25 --dana_g3_iv=0.2 --dana_g3_p=-${dana_g3_p} --weight_decay=0.0 --wandb=True --optimizer="dana"
	'
